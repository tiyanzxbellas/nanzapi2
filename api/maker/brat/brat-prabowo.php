...
// Deskripsi: Prabowo Quote Generator 
// Contoh: {"text":"orang desa gapakai dolar kok"}
...
$text = $_GET['text'] ?? "orang desa gapakai dolar kok";
...
$fontMinSize = 16;
$fontPadding = 20;
$offsetY = 120; // ← ATUR TURUN/NAIK TEKS (makin besar makin turun)

$bgUrl = 'https://tiyanzcode.my.id/Prabowo.png';
...
try {
    ...
    $startY = $frameY1 + ($areaH - $totalTextH) / 2 + $fit['size'] + $offsetY;
